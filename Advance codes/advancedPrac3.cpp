...
public:
    ...
    void runSearch(T x)
    {
        ...
        {
            cout << "Element " << x << " is found in the list at index " << position << " in the list at address " << result << endl;
        }
    }
...
public:
    void run()
    {
        Practical3<D> LinkedList;
        int choice;
        cout << "\nEnter your choice" << endl;
        do
        {
            cout << "1 - Insert an element x at the beginning of the singly linked list" << endl;
            cout << "2 - Insert an element x at the end of the singly linked list" << endl;
            cout << "3 - Insert an element x at position in the singly linked list" << endl;
            cout << "4 - Remove an element from the beginning of the singly linked list" << endl;
            cout << "5 - Remove an element from the end of the singly linked list" << endl;
